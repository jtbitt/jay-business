...
Since I had no experience with <ExternalLink url="https://reactnative.dev/">
React Native</ExternalLink>, I decided to
use<ExternalLink url="https://expo.dev/"> Expo</ExternalLink> to get started as
fast as possible. The goal was to make a working demo of the prospective product
that was more built out than an MVP, which meant having a database of lessons
and authentication to control access to the content.
...
utilized <ExternalLink url="https://firebase.google.com/">
Firebase</ExternalLink> first to authenticate users through Facebook, Google,
and email. I found it somewhat tedious to implement for the first time on
mobile, but once I figured it out, it was pretty straightforward. I could
utilize <ExternalLink url="https://reactjs.org/docs/hooks-intro.html">React
hooks</ExternalLink> to take care of the different authentication API calls.
...
more sense. I didn't want to build a server just to make a database, so I
used&nbsp;<ExternalLink url="https://hasura.io/">Hasura</ExternalLink>, a cloud
PostgreSQL database. It gives you all the features of a relational database and
generates RestAPIs and GraphQL so you can pull the data into your project.
...
flashcard data. You can see my full implementation in the <ExternalLink 
url="https://github.com/jtbitt/fancylingo">code</ExternalLink>.

Finally, I worked hard to make the UI look great, using <ExternalLink 
url="https://cssinjs.org/?v=v10.9.2">CSS-in-JS</ExternalLink> and <ExternalLink 
url="https://web.dev/learn/css/flexbox/">Flexbox</ExternalLink> for everything.
I got it looking good on all mobile screens and matching the design.
